...
import com.example.demo.review.dto.ReviewComment.Request.ReviewCommentLikeRequest;
import com.example.demo.review.dto.ReviewComment.Request.ReviewCommentUpdateRequest;
import com.example.demo.review.dto.ReviewComment.Response.CommentLikeCountResponse;
import com.example.demo.review.dto.ReviewComment.Response.CommentLikeStatusResponse;
import com.example.demo.review.dto.ReviewComment.Response.ReviewCommentCreateResponse;
import com.example.demo.review.dto.ReviewComment.Response.ReviewCommentLikeResponse;
...
public class ReviewCommentController {
    ...
    public ResponseEntity<?> getComments(
        ...
        return ResponseEntity.ok(
                ResponseResult.success(HttpStatus.OK, SuccessMessage.GET_COMMENT_LIST_SUCCESS.getMessage(), comments));
    }
    ...
    public ResponseEntity<?> createComment(
        ...
        return ResponseEntity.status(
                HttpStatus.CREATED).body(ResponseResult.success(HttpStatus.CREATED, SuccessMessage.COMMENT_CREATED.getMessage(), response));
    }
    ...
    public ResponseEntity<?> updateComment(
        ...
        return ResponseEntity.ok(
                ResponseResult.success(HttpStatus.OK, SuccessMessage.COMMENT_UPDATED.getMessage(), response));
    }
    ...
    public ResponseEntity<?> deleteComment(
        ...
        return ResponseEntity.ok(
                ResponseResult.success(HttpStatus.OK, SuccessMessage.COMMENT_DELETED.getMessage(), null));
    }
