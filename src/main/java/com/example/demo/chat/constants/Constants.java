...
public class Constants {
    ...
    public static final String CRAWL_AND_RECOMMEND_URL = "http://localhost:18000/crawl";
    public static final String CRAWL_BY_ARTICLE_NO_URL = "http://localhost:18000/{articleNo}/crawl";
